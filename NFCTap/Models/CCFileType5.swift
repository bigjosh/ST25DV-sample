...
//public class CCFileType5 : ComStSt25sdkType5CCFile {
//
//    var firstBlock : Data
...
//     * @param type5Command Command object to be used to access this CCFile
//     */
//    public convenience init(_ firstBlock : Data, _ secondBlock : Data) {
//        self.firstBlock = firstBlock
//        self.secondBlock = secondBlock
//    }
//
//    func read() throws -> [UInt8]  {
//    //override public func read() throws -> [UInt8] {
//
//        if (!mCacheActivated || mCacheInvalidated) {
//            var readResponse : ReadBlockResult;
//            var buffer : [UInt8];
//
//            // Read first CCFile Block
//            //readResponse = mType5Command.readBlocks(0x00, 0x01);
//    buffer = self.firstBlock  //readResponse.data;
//
//            // buffer contains the block's data
//            // Test buffer size versus the minimum possible value allowed by the ISO standard
//            if (buffer.length < 4) {
...
//
//            // We now know the CCFile length
//            var ccFileContent : ByteBuffer = ByteBuffer.allocate(mCCLength);
//
//            // Copy the first block of the CCFile
//            ccFileContent.put(buffer, 0, mBlockSize);
//
...
//            }
//
//            parseCCFile(ccFileContent.array());
...
//    }
//
//    override public func write() throws {
//        mType5Command.writeBlocks(0, rebuildBuffer());
//    }
//
//    override public func write(buffer : [UInt8]) throws {
//        parseCCFile(buffer);
//        //mType5Command.writeBlocks(0x00, rebuildBuffer());
//    }
//
//    override public func isVicinityHighDensityOverflow() throws -> Bool {
//        throwException() /* throw STException(NOT_IMPLEMENTED); */
//    }
//
//    /**
