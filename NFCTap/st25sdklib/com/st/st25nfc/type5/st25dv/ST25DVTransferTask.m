...
- (void)ST25TransferTaskBufferInitWithInt:(jint)action
...
- (jboolean)isMBEnabledWithBoolean:(jboolean)refresh;

- (jboolean)hasHostPutMsgWithBoolean:(jboolean)refresh;

- (jboolean)hasRFPutMsgWithBoolean:(jboolean)refresh;

- (jint)readMBMessageLength;

- (IOSByteArray *)readMBMessageWithInt:(jint)mbAddress
                               withInt:(jint)size;

- (jbyte)writeMBMessageWithInt:(jint)size
                 withByteArray:(IOSByteArray *)buffer;
...
__attribute__((unused)) static void ComStSt25nfcType5St25dvST25DVTransferTask_ST25TransferTaskBufferInitWithInt_withByteArray_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint action, IOSByteArray *buffer);
...
__attribute__((unused)) static jboolean ComStSt25nfcType5St25dvST25DVTransferTask_isMBEnabledWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh);

__attribute__((unused)) static jboolean ComStSt25nfcType5St25dvST25DVTransferTask_hasHostPutMsgWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh);

__attribute__((unused)) static jboolean ComStSt25nfcType5St25dvST25DVTransferTask_hasRFPutMsgWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh);

__attribute__((unused)) static jint ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageLength(ComStSt25nfcType5St25dvST25DVTransferTask *self);

__attribute__((unused)) static IOSByteArray *ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageWithInt_withInt_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint mbAddress, jint size);

__attribute__((unused)) static jbyte ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint size, IOSByteArray *buffer);

__attribute__((unused)) static jbyte ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_withByte_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint size, IOSByteArray *buffer, jbyte flag);
...
- (void)ST25TransferTaskBufferInitWithInt:(jint)action
                            withByteArray:(IOSByteArray *)buffer {
  ComStSt25nfcType5St25dvST25DVTransferTask_ST25TransferTaskBufferInitWithInt_withByteArray_(self, action, buffer);
}

- (instancetype)initWithInt:(jint)action
              withByteArray:(IOSByteArray *)buffer
withComStSt25sdkType5St25dvST25DVCTag:(ComStSt25sdkType5St25dvST25DVCTag *)tag {
  ComStSt25nfcType5St25dvST25DVTransferTask_initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_(self, action, buffer, tag);
  return self;
}
...
- (void)run {
  ...
  while (ret == ComStSt25nfcType5St25dvST25DVTransferTask_TRY_AGAIN) {
    @try {
      if (ComStSt25nfcType5St25dvST25DVTransferTask_isMBEnabledWithBoolean_(self, true)) ret = ComStSt25nfcType5St25dvST25DVTransferTask_OK;
    ...
    @catch (ComStSt25sdkSTException *e) {
      ...
      AndroidOsSystemClock_sleepWithLong_(ComStSt25nfcType5St25dvST25DVTransferTask_SLEEP_TIME * 5);
    }
  }
  if (ret == ComStSt25nfcType5St25dvST25DVTransferTask_ERROR) {
    mTimeTransfer_ = (jint) AndroidOsSystemClock_elapsedRealtime() - mTimeStamp_;
  ...
  while (mEvent_ == JreLoadEnum(ComStSt25nfcType5St25dvST25DVTransferTask_ST25DVTransferEvent, START) || mEvent_ == JreLoadEnum(ComStSt25nfcType5St25dvST25DVTransferTask_ST25DVTransferEvent, RESUME) || mEvent_ == JreLoadEnum(ComStSt25nfcType5St25dvST25DVTransferTask_ST25DVTransferEvent, PAUSE)) {
    if (mEvent_ != JreLoadEnum(ComStSt25nfcType5St25dvST25DVTransferTask_ST25DVTransferEvent, PAUSE)) {
      @synchronized(self) {
        switch ([mState_ ordinal]) {
          ...
          switch (mAction_) {
            ...
            if (((IOSByteArray *) nil_chk(mBuffer_))->size_ > mMaxPayloadSizeTx_) {
              if (mOffset_ == mBuffer_->size_) {
                ...
                @try {
                  ret = ComStSt25nfcType5St25dvST25DVTransferTask_sendChainedDataWithByte_withBoolean_(self, (jbyte) ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_COMMAND, false);
                }
                @catch (JavaLangException *e) {
                  ret = ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
                }
          ...
          switch (mAction_) {
            ...
            break;
            default:
            ComStSt25sdkSTLog_eWithNSString_(@"Error, state not expected for this action!");
            ret = ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
            break;
          }
          break;
          ...
          ComStSt25sdkSTLog_iWithNSString_(@"ACKNOWLEDGE");
          switch (mAction_) {
            case ComStSt25nfcType5St25dvST25DVTransferTask_FAST_BASIC_TRANSFER_FUNCTION:
            case ComStSt25nfcType5St25dvST25DVTransferTask_FAST_IMAGE_UPLOAD_FUNCTION:
            case ComStSt25nfcType5St25dvST25DVTransferTask_FAST_FIRMWARE_UPDATE_FUNCTION:
      ...
      if (ret == ComStSt25nfcType5St25dvST25DVTransferTask_ERROR) {
        ...
        ComStSt25nfcType5St25dvST25DVTransferTask_sleep_in_msWithInt_(self, ComStSt25nfcType5St25dvST25DVTransferTask_SLEEP_TIME);
      }
    }
...
- (jboolean)isMBEnabledWithBoolean:(jboolean)refresh {
  return ComStSt25nfcType5St25dvST25DVTransferTask_isMBEnabledWithBoolean_(self, refresh);
}

- (jboolean)hasHostPutMsgWithBoolean:(jboolean)refresh {
  return ComStSt25nfcType5St25dvST25DVTransferTask_hasHostPutMsgWithBoolean_(self, refresh);
}

- (jboolean)hasRFPutMsgWithBoolean:(jboolean)refresh {
  return ComStSt25nfcType5St25dvST25DVTransferTask_hasRFPutMsgWithBoolean_(self, refresh);
}

- (jint)readMBMessageLength {
  return ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageLength(self);
}

- (IOSByteArray *)readMBMessageWithInt:(jint)mbAddress
                               withInt:(jint)size {
  return ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageWithInt_withInt_(self, mbAddress, size);
}

- (jbyte)writeMBMessageWithInt:(jint)size
                 withByteArray:(IOSByteArray *)buffer {
  return ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(self, size, buffer);
}

- (jbyte)writeMBMessageWithInt:(jint)size
                 withByteArray:(IOSByteArray *)buffer
                      withByte:(jbyte)flag {
  return ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_withByte_(self, size, buffer, flag);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "Z", 0x2, 23, 24, 12, -1, -1, -1 },
    { NULL, "Z", 0x2, 25, 24, 12, -1, -1, -1 },
    { NULL, "Z", 0x2, 26, 24, 12, -1, -1, -1 },
    { NULL, "I", 0x2, -1, -1, 12, -1, -1, -1 },
    { NULL, "[B", 0x2, 27, 28, 12, -1, -1, -1 },
    { NULL, "B", 0x2, 29, 4, 12, -1, -1, -1 },
    { NULL, "B", 0x2, 29, 30, 12, -1, -1, -1 },
  };
  ...
  methods[1].selector = @selector(initWithInt:withByteArray:withComStSt25sdkType5St25dvST25DVTag:);
  methods[2].selector = @selector(ST25TransferTaskBufferInitWithInt:withByteArray:);
  methods[3].selector = @selector(initWithInt:withByteArray:withComStSt25sdkType5St25dvST25DVCTag:);
  methods[4].selector = @selector(setST25DVTagWithComStSt25sdkType5St25dvST25DVCTag:);
  methods[5].selector = @selector(setST25DVTagWithComStSt25sdkType5St25dvST25DVTag:);
  methods[6].selector = @selector(run);
  methods[7].selector = @selector(sleep_in_msWithInt:);
  methods[8].selector = @selector(prepare);
  methods[9].selector = @selector(checkErrorWithComStSt25sdkSTException:);
  methods[10].selector = @selector(readMessage);
  methods[11].selector = @selector(readHeader);
  methods[12].selector = @selector(sendChainedHeaderWithByteArray:withByte:withByte:withInt:);
  methods[13].selector = @selector(sendSimpleHeaderWithByteArray:withByte:withByte:withInt:);
  ...
  methods[27].selector = @selector(isMBEnabledWithBoolean:);
  methods[28].selector = @selector(hasHostPutMsgWithBoolean:);
  methods[29].selector = @selector(hasRFPutMsgWithBoolean:);
  methods[30].selector = @selector(readMBMessageLength);
  methods[31].selector = @selector(readMBMessageWithInt:withInt:);
  methods[32].selector = @selector(writeMBMessageWithInt:withByteArray:);
  methods[33].selector = @selector(writeMBMessageWithInt:withByteArray:withByte:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "FAST_TRANSFER_COMMAND", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_COMMAND, 0x12, 31, -1, -1, -1 },
    { "FAST_TRANSFER_ANSWER", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_ANSWER, 0x12, 32, -1, -1, -1 },
    { "FAST_TRANSFER_ACK", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_ACK, 0x12, 33, -1, -1, -1 },
    { "FAST_TRANSFER_OK", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_OK, 0x12, 34, -1, -1, -1 },
    { "FAST_TRANSFER_ERROR", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_ERROR, 0x12, 35, -1, -1, -1 },
    { "ERROR", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_ERROR, 0x12, 36, -1, -1, -1 },
    { "TRY_AGAIN", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_TRY_AGAIN, 0x12, 37, -1, -1, -1 },
    { "OK", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_OK, 0x12, 38, -1, -1, -1 },
    { "SLEEP_TIME", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_SLEEP_TIME, 0x12, 39, -1, -1, -1 },
    { "mST25DVTag_", "LComStSt25sdkType5St25dvST25DVTag;", .constantValue.asLong = 0, 0x1, -1, -1, -1, -1 },
    { "mST25DVCTag_", "LComStSt25sdkType5St25dvST25DVCTag;", .constantValue.asLong = 0, 0x1, -1, -1, -1, -1 },
    { "mTransferFunction_", "B", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "mTransferCommand_", "B", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "CHAINED_HEADER_SIZE", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE, 0x12, 40, -1, -1, -1 },
    { "SIMPLE_HEADER_SIZE", "I", .constantValue.asInt = ComStSt25nfcType5St25dvST25DVTransferTask_SIMPLE_HEADER_SIZE, 0x12, 41, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "setTransferListener", "LComStSt25nfcType5St25dvST25DVTransferTask_OnTransferListener;", "I[BLComStSt25sdkType5St25dvST25DVTag;", "ST25TransferTaskBufferInit", "I[B", "I[BLComStSt25sdkType5St25dvST25DVCTag;", "setST25DVTag", "LComStSt25sdkType5St25dvST25DVCTag;", "LComStSt25sdkType5St25dvST25DVTag;", "sleep_in_ms", "I", "checkError", "LComStSt25sdkSTException;", "sendChainedHeader", "[BBBI", "sendSimpleHeader", "sendSimpleData", "B", "sendChainedData", "BZ", "sendCrc", "sendAck", "ZB", "isMBEnabled", "Z", "hasHostPutMsg", "hasRFPutMsg", "readMBMessage", "II", "writeMBMessage", "I[BB", "FAST_TRANSFER_COMMAND", "FAST_TRANSFER_ANSWER", "FAST_TRANSFER_ACK", "FAST_TRANSFER_OK", "FAST_TRANSFER_ERROR", "ERROR", "TRY_AGAIN", "OK", "SLEEP_TIME", "CHAINED_HEADER_SIZE", "SIMPLE_HEADER_SIZE", "LComStSt25nfcType5St25dvST25DVTransferTask_OnTransferListener;LComStSt25nfcType5St25dvST25DVTransferTask_ST25DVTransferEvent;LComStSt25nfcType5St25dvST25DVTransferTask_State;" };
  static const J2ObjcClassInfo _ComStSt25nfcType5St25dvST25DVTransferTask = { "ST25DVTransferTask", "com.st.st25nfc.type5.st25dv", ptrTable, methods, fields, 7, 0x1, 34, 32, -1, 42, -1, -1, -1 };
...
void ComStSt25nfcType5St25dvST25DVTransferTask_initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVTag_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint action, IOSByteArray *buffer, ComStSt25sdkType5St25dvST25DVTag *tag) {
  ...
  ComStSt25nfcType5St25dvST25DVTransferTask_ST25TransferTaskBufferInitWithInt_withByteArray_(self, action, buffer);
  self->mMaxPayloadSizeTx_ = JavaLangMath_minWithInt_withInt_([((id<ComStSt25sdkRFReaderInterface>) nil_chk([((ComStSt25sdkType5St25dvST25DVTag *) nil_chk(tag)) getReaderInterface])) getMaxTransmitLengthInBytes] - 4, ComStSt25sdkType5St25dvST25DVTag_MAILBOX_SIZE) - ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE - 8 - 3;
  self->mMaxPayloadSizeRx_ = JavaLangMath_minWithInt_withInt_([((id<ComStSt25sdkRFReaderInterface>) nil_chk([tag getReaderInterface])) getMaxReceiveLengthInBytes], ComStSt25sdkType5St25dvST25DVTag_MAILBOX_SIZE);
  self->mST25DVCTag_ = nil;
...
void ComStSt25nfcType5St25dvST25DVTransferTask_ST25TransferTaskBufferInitWithInt_withByteArray_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint action, IOSByteArray *buffer) {
...
void ComStSt25nfcType5St25dvST25DVTransferTask_initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint action, IOSByteArray *buffer, ComStSt25sdkType5St25dvST25DVCTag *tag) {
  NSObject_init(self);
  self->mMaxPayloadSizeTx_ = 220;
  self->mMaxPayloadSizeRx_ = 32;
  ComStSt25nfcType5St25dvST25DVTransferTask_ST25TransferTaskBufferInitWithInt_withByteArray_(self, action, buffer);
  self->mMaxPayloadSizeTx_ = JavaLangMath_minWithInt_withInt_([((id<ComStSt25sdkRFReaderInterface>) nil_chk([((ComStSt25sdkType5St25dvST25DVCTag *) nil_chk(tag)) getReaderInterface])) getMaxTransmitLengthInBytes] - 4, ComStSt25sdkType5St25dvST25DVTag_MAILBOX_SIZE) - ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE - 8 - 3;
  self->mMaxPayloadSizeRx_ = JavaLangMath_minWithInt_withInt_([((id<ComStSt25sdkRFReaderInterface>) nil_chk([tag getReaderInterface])) getMaxReceiveLengthInBytes], ComStSt25sdkType5St25dvST25DVTag_MAILBOX_SIZE);
  self->mST25DVTag_ = nil;
  self->mST25DVCTag_ = tag;
}

ComStSt25nfcType5St25dvST25DVTransferTask *new_ComStSt25nfcType5St25dvST25DVTransferTask_initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_(jint action, IOSByteArray *buffer, ComStSt25sdkType5St25dvST25DVCTag *tag) {
  J2OBJC_NEW_IMPL(ComStSt25nfcType5St25dvST25DVTransferTask, initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_, action, buffer, tag)
}

ComStSt25nfcType5St25dvST25DVTransferTask *create_ComStSt25nfcType5St25dvST25DVTransferTask_initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_(jint action, IOSByteArray *buffer, ComStSt25sdkType5St25dvST25DVCTag *tag) {
  J2OBJC_CREATE_IMPL(ComStSt25nfcType5St25dvST25DVTransferTask, initWithInt_withByteArray_withComStSt25sdkType5St25dvST25DVCTag_, action, buffer, tag)
}
...
IOSByteArray *ComStSt25nfcType5St25dvST25DVTransferTask_readMessage(ComStSt25nfcType5St25dvST25DVTransferTask *self) {
  jint length = ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageLength(self);
  IOSByteArray *buffer;
  ...
  jint offset = 0;
  while (offset < length) {
    jint size = ((length - offset) > self->mMaxPayloadSizeRx_) ? self->mMaxPayloadSizeRx_ : length - offset;
    tmpBuffer = ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageWithInt_withInt_(self, (jbyte) offset, size);
    ...
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(tmpBuffer, 1, buffer, offset, tmpBuffer->size_ - 1);
    offset += tmpBuffer->size_ - 1;
  }
  return buffer;
}
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_readHeader(ComStSt25nfcType5St25dvST25DVTransferTask *self) {
  ...
  if (IOSByteArray_Get(response, 0) != ComStSt25nfcType5St25dvST25DVTransferTask_FAST_IMAGE_DOWNLOAD_FUNCTION && IOSByteArray_Get(response, 0) != ComStSt25nfcType5St25dvST25DVTransferTask_FAST_RANDOM_TRANSFER_FUNCTION) return ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
  self->mTransferFunction_ = IOSByteArray_Get(response, 0);
  self->mTransferCommand_ = IOSByteArray_Get(response, 1);
  if (IOSByteArray_Get(response, 2) != ComStSt25nfcType5St25dvST25DVTransferTask_FAST_TRANSFER_OK || IOSByteArray_Get(response, 3) != (jint) 0x01) return ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
  length = ((JreLShift32(IOSByteArray_Get(response, 4), 24)) & (jint) 0xFF000000) + ((JreLShift32(IOSByteArray_Get(response, 5), 16)) & (jint) 0x00FF0000) + ((JreLShift32(IOSByteArray_Get(response, 6), 8)) & (jint) 0x0000FF00) + (IOSByteArray_Get(response, 7) & (jint) 0xFF);
  ...
  jint nbOfChunks = ((JreLShift32(IOSByteArray_Get(response, 8), 8)) & (jint) 0xFF) + ((IOSByteArray_Get(response, 9)) & (jint) 0xFF);
  jint chunk = ((JreLShift32(IOSByteArray_Get(response, 10), 8)) & (jint) 0xFF) + ((IOSByteArray_Get(response, 11)) & (jint) 0xFF);
  length = IOSByteArray_Get(response, 12) & (jint) 0xFF;
  if (length > 0 && response->size_ <= ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE + length) {
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(response, ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE, self->mBuffer_, 0, length);
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_readChainedData(ComStSt25nfcType5St25dvST25DVTransferTask *self) {
  @try {
    if (!ComStSt25nfcType5St25dvST25DVTransferTask_hasHostPutMsgWithBoolean_(self, true)) return ComStSt25nfcType5St25dvST25DVTransferTask_TRY_AGAIN;
  }
  @catch (ComStSt25sdkSTException *e) {
    return ComStSt25nfcType5St25dvST25DVTransferTask_checkErrorWithComStSt25sdkSTException_(self, e);
  }
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_sendSimpleDataWithByte_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jbyte command) {
  @try {
    if (ComStSt25nfcType5St25dvST25DVTransferTask_hasRFPutMsgWithBoolean_(self, true)) return ComStSt25nfcType5St25dvST25DVTransferTask_TRY_AGAIN;
  }
  @catch (ComStSt25sdkSTException *e) {
    return ComStSt25nfcType5St25dvST25DVTransferTask_checkErrorWithComStSt25sdkSTException_(self, e);
  }
  jbyte response;
  IOSByteArray *frame = [IOSByteArray newArrayWithLength:self->mMaxPayloadSizeTx_ + ComStSt25nfcType5St25dvST25DVTransferTask_SIMPLE_HEADER_SIZE];
  ...
  @try {
    ...
    if (ComStSt25nfcType5St25dvST25DVTransferTask_sendSimpleHeaderWithByteArray_withByte_withByte_withInt_(self, frame, (jbyte) self->mAction_, command, size) == ComStSt25nfcType5St25dvST25DVTransferTask_ERROR) return ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(self->mBuffer_, self->mOffset_, frame, ComStSt25nfcType5St25dvST25DVTransferTask_SIMPLE_HEADER_SIZE, size);
    response = ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(self, size + ComStSt25nfcType5St25dvST25DVTransferTask_SIMPLE_HEADER_SIZE, frame);
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_sendChainedDataWithByte_withBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jbyte command, jboolean checkRf) {
  ...
  @try {
    ...
    response = ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(self, size + ComStSt25nfcType5St25dvST25DVTransferTask_CHAINED_HEADER_SIZE, frame);
    if (response == (jint) 0x00) self->mOffset_ += size;
    else return ComStSt25nfcType5St25dvST25DVTransferTask_ERROR;
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_sendCrcWithByte_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jbyte function) {
  ...
  *IOSByteArray_GetRef(frame, 8) = (jbyte) (crc & (jint) 0x000000FF);
  ComStSt25sdkSTLog_iWithNSString_(JreStrcat("$$", @"sendCrc: ", NSString_java_valueOfLong_(crc)));
  @try {
    response = ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(self, frame->size_, frame);
...
jint ComStSt25nfcType5St25dvST25DVTransferTask_sendAckWithBoolean_withByte_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean success, jbyte function) {
  ...
  *IOSByteArray_GetRef(frame, 4) = 0;
  @try {
    response = ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(self, 5, frame);
...
jboolean ComStSt25nfcType5St25dvST25DVTransferTask_isMBEnabledWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh) {
  JavaLangBoolean *ret = JavaLangBoolean_valueOfWithBoolean_(false);
  if (self->mST25DVTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVTag_ isMailboxEnabledWithBoolean:true]);
  }
  if (self->mST25DVCTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVCTag_ isMailboxEnabledWithBoolean:true]);
  }
  return [ret booleanValue];
}

jboolean ComStSt25nfcType5St25dvST25DVTransferTask_hasHostPutMsgWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh) {
  JavaLangBoolean *ret = JavaLangBoolean_valueOfWithBoolean_(false);
  if (self->mST25DVTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVTag_ hasHostPutMsgWithBoolean:true]);
  }
  if (self->mST25DVCTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVCTag_ hasHostPutMsgWithBoolean:true]);
  }
  return [ret booleanValue];
}

jboolean ComStSt25nfcType5St25dvST25DVTransferTask_hasRFPutMsgWithBoolean_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jboolean refresh) {
  JavaLangBoolean *ret = JavaLangBoolean_valueOfWithBoolean_(false);
  if (self->mST25DVTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVTag_ hasRFPutMsgWithBoolean:true]);
  }
  if (self->mST25DVCTag_ != nil) {
    ret = JavaLangBoolean_valueOfWithBoolean_([self->mST25DVCTag_ hasRFPutMsgWithBoolean:true]);
  }
  return [ret booleanValue];
}

jint ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageLength(ComStSt25nfcType5St25dvST25DVTransferTask *self) {
  jint ret = 0;
  if (self->mST25DVTag_ != nil) {
    ret = [self->mST25DVTag_ readMailboxMessageLength];
  }
  if (self->mST25DVCTag_ != nil) {
    ret = [self->mST25DVCTag_ readMailboxMessageLength];
  }
  return ret;
}

IOSByteArray *ComStSt25nfcType5St25dvST25DVTransferTask_readMBMessageWithInt_withInt_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint mbAddress, jint size) {
  IOSByteArray *ret = nil;
  if (self->mST25DVTag_ != nil) {
    ret = [self->mST25DVTag_ readMailboxMessageWithInt:(jbyte) mbAddress withInt:size];
  }
  if (self->mST25DVCTag_ != nil) {
    ret = [self->mST25DVCTag_ readMailboxMessageWithInt:(jbyte) mbAddress withInt:size];
  }
  return ret;
}

jbyte ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint size, IOSByteArray *buffer) {
  jbyte ret = (jint) 0x01;
  if (self->mST25DVTag_ != nil) {
    ret = [self->mST25DVTag_ writeMailboxMessageWithInt:size withByteArray:buffer];
  }
  if (self->mST25DVCTag_ != nil) {
    ret = [self->mST25DVCTag_ writeMailboxMessageWithInt:size withByteArray:buffer];
  }
  return ret;
}

jbyte ComStSt25nfcType5St25dvST25DVTransferTask_writeMBMessageWithInt_withByteArray_withByte_(ComStSt25nfcType5St25dvST25DVTransferTask *self, jint size, IOSByteArray *buffer, jbyte flag) {
  jbyte ret = (jint) 0x01;
  if (self->mST25DVTag_ != nil) {
    ret = [self->mST25DVTag_ writeMailboxMessageWithInt:size withByteArray:buffer withByte:flag];
  }
  if (self->mST25DVCTag_ != nil) {
    ret = [self->mST25DVCTag_ writeMailboxMessageWithInt:size withByteArray:buffer withByte:flag];
  }
  return ret;
}
