...
typedef NS_ENUM(NSUInteger, ComStSt25sdkRFReaderInterface_InventoryMode_Enum) {
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_TYPE_4A = 0,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_TYPE_4B = 1,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_ISO14443SR = 2,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_TYPE_5 = 3,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_TYPE1 = 4,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_TYPE3 = 5,
  ComStSt25sdkRFReaderInterface_InventoryMode_Enum_NFC_PICOPASS = 6,
};
