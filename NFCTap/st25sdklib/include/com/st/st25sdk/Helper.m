...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "[B", 0x9, 32, 5, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 33, 34, 16, -1, -1, -1 },
    { NULL, "I", 0x9, 35, 3, -1, -1, -1, -1 },
    { NULL, "C", 0x9, 36, 3, 16, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 37, 34, 16, -1, -1, -1 },
    { NULL, "I", 0x9, 38, 7, 16, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 39, 3, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 40, 5, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 41, 31, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 42, 7, -1, -1, -1, -1 },
  ...
  methods[21].selector = @selector(concatenateByteArraysWithByteArray:withByteArray:);
  methods[22].selector = @selector(reverseByteArrayWithByteArray:);
  methods[23].selector = @selector(divisionRoundedUpWithInt:withInt:);
  methods[24].selector = @selector(convertByteToUnsignedIntWithByte:);
  methods[25].selector = @selector(convertByteToAsciiCharWithByte:);
  methods[26].selector = @selector(convertHexValueToReversedAsciiStringWithInt:withInt:);
  methods[27].selector = @selector(convertAsciiStringToReversedHexValueWithNSString:);
  methods[28].selector = @selector(convertHexByteToAsciiStringWithByte:);
  methods[29].selector = @selector(convertHexByteArrayToAsciiStringWithByteArray:);
  methods[30].selector = @selector(findSubArrayPositionWithByteArray:withByteArray:);
  methods[31].selector = @selector(isStringInST25AsciiTableWithNSString:);
  methods[32].selector = @selector(isCharacterInST25AsciiTableWithChar:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "hexArray", "[C", .constantValue.asLong = 0, 0x1a, -1, 45, -1, -1 },
  };
  static const void *ptrTable[] = { "stringForceDigit", "LNSString;I", "convertByteToHexString", "B", "convertHexByteArrayToString", "[B", "convertAsciiStringToHexString", "LNSString;", "printHexByteArray", "LNSString;[B", "convertIntToHexFormatString", "I", "convertHexStringToByteArray", "convertByteArrayToHexString", "convertStringToInt", "convertHexStringToInt", "LComStSt25sdkSTException;", "convertHexStringToByte", "convertIntTo4BytesHexaFormat", "convert4BytesHexaFormatToInt", "convertIntTo3BytesHexaFormat", "convert3BytesHexaFormatToInt", "convertIntTo2BytesHexaFormat", "convert2BytesHexaFormatToInt", "readNextByteOfByteArrayInputStream", "LJavaIoByteArrayInputStream;", "readNextBlockOfByteArrayInputStream", "LJavaIoByteArrayInputStream;I", (void *)&ComStSt25sdkHelper__Annotations$0, "readByteArrayInputStream", "concatenateByteArrays", "[B[B", "reverseByteArray", "divisionRoundedUp", "II", "convertByteToUnsignedInt", "convertByteToAsciiChar", "convertHexValueToReversedAsciiString", "convertAsciiStringToReversedHexValue", "convertHexByteToAsciiString", "convertHexByteArrayToAsciiString", "findSubArrayPosition", "isStringInST25AsciiTable", "isCharacterInST25AsciiTable", "C", &ComStSt25sdkHelper_hexArray };
  static const J2ObjcClassInfo _ComStSt25sdkHelper = { "Helper", "com.st.st25sdk", ptrTable, methods, fields, 7, 0x1, 33, 1, -1, -1, -1, -1, -1 };
...
void ComStSt25sdkHelper_printHexByteArrayWithNSString_withByteArray_(NSString *msg, IOSByteArray *byteArrayToPrint) {
  ...
  jint chunkSize = 32;
  if (byteArrayToPrint == nil) return;
...
jint ComStSt25sdkHelper_convertHexStringToIntWithNSString_(NSString *hexNumber) {
  ...
  return JavaLangInteger_parseIntWithNSString_withInt_(hexNumber, 16);
}
...
IOSByteArray *ComStSt25sdkHelper_reverseByteArrayWithByteArray_(IOSByteArray *array) {
  ...
  for (jint i = 0; i < array->size_; i++) *IOSByteArray_GetRef(ret, i) = IOSByteArray_Get(array, array->size_ - 1 - i);
  return ret;
}
