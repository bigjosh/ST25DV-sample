...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "[B", 0x9, 14, 12, -1, -1, -1, -1 },
    { NULL, "[B", 0x9, 15, 12, -1, -1, -1, -1 },
    { NULL, "[B", 0x9, 16, 1, -1, -1, -1, -1 },
    { NULL, "B", 0x1, -1, -1, -1, -1, -1, -1 },
  ...
  methods[15].selector = @selector(addNdefTlvWithByteArray:withByteArray:);
  methods[16].selector = @selector(addProprietaryTlvWithByteArray:withByteArray:);
  methods[17].selector = @selector(addTerminatorTlvWithByteArray:);
  methods[18].selector = @selector(getType);
  methods[19].selector = @selector(getLength);
  methods[20].selector = @selector(getValue);
  methods[21].selector = @selector(getTlvSize);
  ...
  static const void *ptrTable[] = { "[BI", "[B", "parse", "buildTlvBuffer", "BI[B", "buildLockControlTlv", "LComStSt25sdkSTException;", "buildMemoryControlTlv", "buildNdefTlv", "buildProprietaryTlv", "addNullTlv", "addLockControlTlv", "[B[B", "addMemoryControlTlv", "addNdefTlv", "addProprietaryTlv", "addTerminatorTlv" };
  static const J2ObjcClassInfo _ComStSt25sdkControlTlv = { "ControlTlv", "com.st.st25sdk", ptrTable, methods, fields, 7, 0x1, 22, 10, -1, -1, -1, -1, -1 };
