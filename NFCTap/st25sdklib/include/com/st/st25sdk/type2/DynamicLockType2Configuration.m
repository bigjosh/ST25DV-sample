...
- (jint)getDlaNbrBytesLockedPerBit {
  return mDlaNbrBytesLockedPerBit_;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "mDlaNbrBytesLockedPerBit_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
...
void ComStSt25sdkType2DynamicLockType2Configuration_initWithInt_(ComStSt25sdkType2DynamicLockType2Configuration *self, jint t2tAreaSize) {
  ...
  self->mDlaNbrBytesLockedPerBit_ = 8;
  self->mDlaFirstByteAddress_ = t2tAreaSize + 16;
  self->mDlaNbrLockBits_ = (t2tAreaSize - ComStSt25sdkType2DynamicLockType2_STATIC_AREA_USER_MEMORY_MAX_SIZE) / self->mDlaNbrBytesLockedPerBit_;
...
void ComStSt25sdkType2DynamicLockType2Configuration_initWithComStSt25sdkControlTlv_(ComStSt25sdkType2DynamicLockType2Configuration *self, ComStSt25sdkControlTlv *lockControlTlv) {
  ...
  jint mos = IOSByteArray_Get(lockControlTlvBytes, 2) & (jint) 0xF;
  jint blplb = (JreRShift32((IOSByteArray_Get(lockControlTlvBytes, 2) & (jint) 0xF0), 4)) & (jint) 0xFF;
  ...
  self->mDlaNbrBytes_ = ((self->mDlaNbrLockBits_ - 1) / 8) + 1;
  self->mDlaNbrBytesLockedPerBit_ = (JreLShift32(1, blplb));
}
