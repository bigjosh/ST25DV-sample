...
@interface ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 : NSObject < ComStSt25sdkSTRegister_RegisterListener > {
 @public
  ComStSt25sdkType5St25dvpwmST25DVPwmTag *this$0_;
}

- (instancetype)initWithComStSt25sdkType5St25dvpwmST25DVPwmTag:(ComStSt25sdkType5St25dvpwmST25DVPwmTag *)outer$;

- (void)registerChange;

@end

J2OBJC_EMPTY_STATIC_INIT(ComStSt25sdkType5St25dvpwmST25DVPwmTag_1)

__attribute__((unused)) static void ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *self, ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$);

__attribute__((unused)) static ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *new_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *create_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$);
...
- (ComStSt25sdkType5St25dvpwmST25DV02KWRegisterPwmRfConfiguration_OutputDriverTrimming *)getPwmOutputDriverTrimmingWithInt:(jint)pwmNumber {
  ...
  if (!ComStSt25sdkType5St25dvpwmST25DVPwmTag_isPwmNumberValidWithInt_(self, pwmNumber)) @throw new_ComStSt25sdkSTException_initWithComStSt25sdkSTException_STExceptionCode_(JreLoadEnum(ComStSt25sdkSTException_STExceptionCode, BAD_PARAMETER));
  switch (pwmNumber) {
    case 1:
...
- (jint)computePeriodWithInt:(jint)freq {
  if (freq > ComStSt25sdkType5St25dvpwmST25DVPwmTag_ST25DVPWM_PWM_MAX_FREQ || freq < ComStSt25sdkType5St25dvpwmST25DVPwmTag_ST25DVPWM_PWM_MIN_FREQ) @throw new_ComStSt25sdkSTException_initWithComStSt25sdkSTException_STExceptionCode_(JreLoadEnum(ComStSt25sdkSTException_STExceptionCode, BAD_PARAMETER));
...
- (jint)computePulseWidthWithInt:(jint)period
  ...
  if (period < 0 || dutyCycle < 0 || dutyCycle > 100) @throw new_ComStSt25sdkSTException_initWithComStSt25sdkSTException_STExceptionCode_(JreLoadEnum(ComStSt25sdkSTException_STExceptionCode, BAD_PARAMETER));
...
void ComStSt25sdkType5St25dvpwmST25DVPwmTag_initWithComStSt25sdkRFReaderInterface_withByteArray_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *self, id<ComStSt25sdkRFReaderInterface> readerInterface, IOSByteArray *uid) {
  ...
  [self initAreaList];
  [((ComStSt25sdkType5St25tvST25TVRegisterArea1SecurityAttribute *) nil_chk(self->mRegisterArea1SecurityAttribute_)) addRegisterListenerWithComStSt25sdkSTRegister_RegisterListener:new_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(self)];
...
jint ComStSt25sdkType5St25dvpwmST25DVPwmTag_computePeriodFromControlWithByteArray_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *self, IOSByteArray *control) {
  if (control == nil || control->size_ < 4) return 0;
...
jint ComStSt25sdkType5St25dvpwmST25DVPwmTag_computeDutyCycleFromControlWithByteArray_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *self, IOSByteArray *control) {
  ...
  if (period != 0) {
    if (((100 * ComStSt25sdkType5St25dvpwmST25DVPwmTag_computePulseWidthFromControlWithByteArray_(self, control)) % period) == 0) return (100 * ComStSt25sdkType5St25dvpwmST25DVPwmTag_computePulseWidthFromControlWithByteArray_(self, control)) / period;
...
void ComStSt25sdkType5St25dvpwmST25DVPwmTag_computeControlFromPeriodAndPulseWidthWithByteArray_withInt_withInt_withBoolean_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *self, IOSByteArray *control, jint period, jint pulseWidth, jboolean pwmEnable) {
  if (control == nil || control->size_ < 4) return;
...
@implementation ComStSt25sdkType5St25dvpwmST25DVPwmTag_1

- (instancetype)initWithComStSt25sdkType5St25dvpwmST25DVPwmTag:(ComStSt25sdkType5St25dvpwmST25DVPwmTag *)outer$ {
  ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(initWithComStSt25sdkType5St25dvpwmST25DVPwmTag:);
  methods[1].selector = @selector(registerChange);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LComStSt25sdkType5St25dvpwmST25DVPwmTag;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LComStSt25sdkSTException;", "LComStSt25sdkType5St25dvpwmST25DVPwmTag;", "initWithComStSt25sdkRFReaderInterface:withByteArray:" };
  static const J2ObjcClassInfo _ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 = { "", "com.st.st25sdk.type5.st25dvpwm", ptrTable, methods, fields, 7, 0x8010, 2, 1, 1, -1, 2, -1, -1 };
  return &_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1;
}

@end

void ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *self, ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$) {
  self->this$0_ = outer$;
  NSObject_init(self);
}

ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *new_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$) {
  J2OBJC_NEW_IMPL(ComStSt25sdkType5St25dvpwmST25DVPwmTag_1, initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_, outer$)
}

ComStSt25sdkType5St25dvpwmST25DVPwmTag_1 *create_ComStSt25sdkType5St25dvpwmST25DVPwmTag_1_initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_(ComStSt25sdkType5St25dvpwmST25DVPwmTag *outer$) {
  J2OBJC_CREATE_IMPL(ComStSt25sdkType5St25dvpwmST25DVPwmTag_1, initWithComStSt25sdkType5St25dvpwmST25DVPwmTag_, outer$)
}
