...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComStSt25sdkNdefNDEFMsg;", 0x401, -1, -1, 1, -1, -1, -1 },
    { NULL, "[B", 0x401, -1, -1, 1, -1, -1, -1 },
    ...
    { NULL, "LNSString;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "[LNSString;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComStSt25sdkNFCTag_NfcTagTypes;", 0x1, -1, -1, 1, -1, -1, -1 },
    { NULL, "[B", 0x401, -1, -1, 1, -1, -1, -1 },
  };
  ...
  methods[3].selector = @selector(getCCFileLength);
  methods[4].selector = @selector(getCCMagicNumber);
  methods[5].selector = @selector(getCCMappingVersion);
  methods[6].selector = @selector(getCCReadAccess);
  methods[7].selector = @selector(getCCWriteAccess);
  methods[8].selector = @selector(getCCMemorySize);
  methods[9].selector = @selector(isEqual:);
  methods[10].selector = @selector(writeNdefMessageWithComStSt25sdkNdefNDEFMsg:);
  methods[11].selector = @selector(readNdefMessage);
  methods[12].selector = @selector(readCCFile);
  methods[13].selector = @selector(writeCCFile);
  methods[14].selector = @selector(writeCCFileWithByteArray:);
  methods[15].selector = @selector(initEmptyCCFile);
  methods[16].selector = @selector(getSysFileLength);
  methods[17].selector = @selector(getICRef);
  methods[18].selector = @selector(getMemSizeInBytes);
  methods[19].selector = @selector(readBytesWithInt:withInt:);
  methods[20].selector = @selector(writeBytesWithInt:withByteArray:);
  methods[21].selector = @selector(getManufacturerName);
  methods[22].selector = @selector(getUidString);
  methods[23].selector = @selector(getUid);
  methods[24].selector = @selector(getName);
  methods[25].selector = @selector(setNameWithNSString:);
  methods[26].selector = @selector(getTypeDescription);
  methods[27].selector = @selector(getDescription);
  methods[28].selector = @selector(getTechList);
  methods[29].selector = @selector(getType);
...
ComStSt25sdkNFCTag_NfcTagTypes *ComStSt25sdkNFCTag_NfcTagTypes_values_[13];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "NFC_TAG_ISO18092", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 6, -1, -1 },
    { "NFC_TAG_TYPE_4A", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 7, -1, -1 },
    { "NFC_TAG_TYPE_4B", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 8, -1, -1 },
    { "NFC_TAG_ISO14443SR", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 9, -1, -1 },
    { "NFC_TAG_TYPE_A", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 10, -1, -1 },
    { "NFC_TAG_TYPE_B", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 11, -1, -1 },
    { "NFC_TAG_TYPE_F", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 12, -1, -1 },
    { "NFC_TAG_TYPE_V", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 13, -1, -1 },
    { "NFC_TAG_PICOPASS", "LComStSt25sdkNFCTag_NfcTagTypes;", .constantValue.asLong = 0, 0x4019, -1, 14, -1, -1 },
  };
  static const void *ptrTable[] = { "valueOf", "LNSString;", &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_UNKNOWN), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_1), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_2), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_3), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_ISO18092), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_4A), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_4B), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_ISO14443SR), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_A), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_B), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_F), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_V), &JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_PICOPASS), "LComStSt25sdkNFCTag;", "Ljava/lang/Enum<Lcom/st/st25sdk/NFCTag$NfcTagTypes;>;" };
  static const J2ObjcClassInfo _ComStSt25sdkNFCTag_NfcTagTypes = { "NfcTagTypes", "com.st.st25sdk", ptrTable, methods, fields, 7, 0x4019, 2, 13, 15, -1, -1, 16, -1 };
...
+ (void)initialize {
  if (self == [ComStSt25sdkNFCTag_NfcTagTypes class]) {
    ...
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_ISO18092) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 4), 4);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_4A) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 5), 5);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_4B) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 6), 6);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_ISO14443SR) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 7), 7);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_A) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 8), 8);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_B) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 9), 9);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_F) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 10), 10);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_TYPE_V) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 11), 11);
    JreEnum(ComStSt25sdkNFCTag_NfcTagTypes, NFC_TAG_PICOPASS) = new_ComStSt25sdkNFCTag_NfcTagTypes_initWithNSString_withInt_(JreEnumConstantName(ComStSt25sdkNFCTag_NfcTagTypes_class_(), 12), 12);
...
IOSObjectArray *ComStSt25sdkNFCTag_NfcTagTypes_values() {
  ...
  return [IOSObjectArray arrayWithObjects:ComStSt25sdkNFCTag_NfcTagTypes_values_ count:13 type:ComStSt25sdkNFCTag_NfcTagTypes_class_()];
}
