...
//        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillHide(sender:)), name: UIResponder.keyboardWillHideNotification, object: nil);
    ...
    private func readTagRegistersConfiguration() {
        if mTag is ST25TVTag {
            ...
            readTagRegistersConfiguration(tag: mTag as! ST25DVCTag)
...
extension ST25RegistersViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func setCell(action:actionOnRegisterToDo, at indexPath: IndexPath){
        ...
        if action == .write {
            let scanner = Scanner(string: cell.registerCellValueLabel.text!)
            var value: UInt64 = 0
            ...
            if value != nil {
                //print("Save actual register value to tag : \(cell.registerInfo.mRegister.getValue())")
                //print("Save new register value to tag : \(cell.registerCellValueLabel.text)")
